...
1.According to the principle of legality, legitimacy and necessity, only the information necessary for the realization of product functions shall be collected.(1)When you use our network services or visit our platform web pages, we automatically receive and record the information on your browser and computer, including but not limited to your IP address, browser type, language used, access date and time, software and hardware feature information and web page records you need;(2)When you use the video or picture editing function for the first time, we will obtain your local media storage permission for you to select the video or picture and modify the save path; this permission is only for the user to edit and save. We will not obtain any video or picture material files of users.(3)When you use the recording-related functions of the software, we will obtain your microphone permission to record audio. The recorded audio is only for your current editing use, we will not obtain audio files.(4)Our products use Admob, Tencent as advertisers. Advertisers want to show ads that are relevant to you. For more advertiser information, please check the following page: https://support.google.com/admob/answer/6128543? hl=en,https://e.qq.com/ads/?from=02_PINPAI_146.(5)When you send feedback via email or provide us with an error report, we will obtain your personal information. Please understand that this information is limited to your name, email address and the content of your survey response.
2.You understand and agree that the following information does not apply to this privacy policy:(1) The keyword information you enter when using the services we provide;(2) The relevant information and data we have collected that you publish on the service platform we provide;(3) Violation of the law or violation of our rules and the measures we have taken against you.\
